      ...
      <footer className="mt-8 pb-8">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="flex-1 h-px" style={{ background: 'linear-gradient(to right, transparent, #E8C8BA)' }} />
            <span style={{ color: '#C9A84C', fontSize: 14 }}>✦</span>
            <div className="flex-1 h-px" style={{ background: 'linear-gradient(to left, transparent, #E8C8BA)' }} />
          </div>

          {/* Evento */}
          <div className="flex items-center justify-center gap-1.5 mb-4">
            <Heart size={11} style={{ color: '#C9846B' }} />
            <span className="text-xs" style={{ color: '#B08070' }}>
              Feito com amor para os 80 anos de Antônia Lucena
            </span>
            <Heart size={11} style={{ color: '#C9846B' }} />
          </div>
          ...
          <div
            className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 py-3 px-5 rounded-2xl mx-auto max-w-sm"
            style={{ backgroundColor: 'white', border: '1px solid #F0E4DE' }}
          >
            <span className="text-xs font-semibold" style={{ color: '#B08070' }}>
              Desenvolvido por
            </span>
            ...
            <div className="flex items-center gap-2">
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/marcosvinicius1/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all hover:opacity-80 active:scale-95"
                style={{ backgroundColor: '#0A66C2', color: 'white' }}
                aria-label="LinkedIn de Marcos Vinicius"
              >
              ...
              {/* GitHub */}
              <a
                href="https://github.com/MarcosViniicius"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all hover:opacity-80 active:scale-95"
                style={{ backgroundColor: '#24292F', color: 'white' }}
                aria-label="GitHub de Marcos Vinicius"
              >
                <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
